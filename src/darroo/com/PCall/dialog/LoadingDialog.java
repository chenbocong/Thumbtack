package darroo.com.PCall.dialog;
...
public class LoadingDialog extends Dialog {
    ...
    private void init() {
        setContentView(R.layout.progressdialog_no_deal);
        iv_route = (ImageView) findViewById(R.id.img);
        detail_tv = (TextView) findViewById(R.id.tipTextView);
