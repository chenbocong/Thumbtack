...
/**
 * Created by Hankkin on 2015/7/13. 上报Fragment
 */
public class ReportFragment extends Fragment implements View.OnClickListener {
	...
	private Button datetextvew;
	private Button saoysao;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		/**
		 * 点击当前位置图标弹出位置信息popwindow by Hankkin at:2015年8月4日 21:15:09
		 */
	...
	private void initViews() {
		datetextvew = (Button) getActivity().findViewById(R.id.date_textview);
		datetextvew.setOnClickListener(this);
		btnLoc = (Button) getActivity().findViewById(R.id.btn_report_locRepeat);
		btnLoc.setOnClickListener(this);
		saoysao = (Button) getActivity().findViewById(R.id.saoysao);
		...
		// 定位初始化
		if (CheckHasNet.isMobileNet(getActivity().getApplicationContext())
				|| CheckHasNet.isNetWorkOk(getActivity().getApplicationContext())) {
	...
	public void onClick(View view) {
		...
		case R.id.date_textview:
			Intent intent = new Intent(getActivity().getApplicationContext(), DetailedInformationActivity.class);
			startActivity(intent);
			break;
		case R.id.saoysao:
			Intent intent2 = new Intent(getActivity().getApplicationContext(),CaptureActivity.class);
	...
	/**
	 * 定位SDK监听函数 by Hankkin at:2015年7月14日 21:28:12
	 */
