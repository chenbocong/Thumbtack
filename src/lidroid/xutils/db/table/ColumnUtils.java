...
package lidroid.xutils.db.table;

import android.text.TextUtils;
import lidroid.xutils.db.annotation.*;
import lidroid.xutils.db.annotation.Column;
import lidroid.xutils.db.annotation.Finder;
import lidroid.xutils.db.annotation.Foreign;
import lidroid.xutils.db.annotation.Id;
import lidroid.xutils.db.converter.ColumnConverter;
import lidroid.xutils.db.converter.ColumnConverterFactory;
import lidroid.xutils.db.sqlite.FinderLazyLoader;
import lidroid.xutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(lidroid.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(lidroid.xutils.db.table.Finder finderColumn) {
