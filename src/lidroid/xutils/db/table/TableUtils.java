...
import lidroid.xutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, lidroid.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, lidroid.xutils.db.table.Id>();

    /* package */
    static synchronized lidroid.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        lidroid.xutils.db.table.Id id = new lidroid.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        lidroid.xutils.db.table.Id id = getId(entityType);
