...
import lidroid.xutils.http.*;
import lidroid.xutils.http.callback.HttpRedirectHandler;
import lidroid.xutils.http.callback.RequestCallBack;
import lidroid.xutils.http.client.DefaultSSLSocketFactory;
import lidroid.xutils.http.client.HttpRequest;
import lidroid.xutils.http.client.RetryHandler;
import lidroid.xutils.http.client.entity.GZipDecompressingEntity;
...
public class HttpUtils {
    ...
    private final static int DEFAULT_CONN_TIMEOUT = 1000 * 30; // 15s
