...
import lidroid.xutils.bitmap.BitmapCacheListener;
import lidroid.xutils.bitmap.BitmapCommonUtils;
import lidroid.xutils.bitmap.BitmapDisplayConfig;
import lidroid.xutils.bitmap.BitmapGlobalConfig;
import lidroid.xutils.bitmap.callback.BitmapLoadCallBack;
import lidroid.xutils.bitmap.callback.BitmapLoadFrom;
import lidroid.xutils.bitmap.callback.DefaultBitmapLoadCallBack;
import lidroid.xutils.bitmap.core.AsyncDrawable;
import lidroid.xutils.bitmap.core.BitmapSize;
import lidroid.xutils.bitmap.download.Downloader;
import lidroid.xutils.cache.FileNameGenerator;
import lidroid.xutils.task.PriorityAsyncTask;
import lidroid.xutils.task.PriorityExecutor;
import lidroid.xutils.task.TaskHandler;
