...
package lidroid.xutils.http.client;

import lidroid.xutils.http.RequestParams;
import lidroid.xutils.http.callback.RequestCallBackHandler;
import lidroid.xutils.http.client.entity.UploadEntity;
import lidroid.xutils.http.client.util.URIBuilder;
